"""
Originally from nnUnet paper.
Found in someone's forked repo:
https://github.com/YtongXie/CoTr/blob/04dc65a225897eb8fd4071f539f33027fab8a328/nnUNet/nnunet/training/loss_functions/dice_loss.py#L304
"""
...
from .nnunet_utils import sum_tensor, softmax_helper
...
class DC_and_CE_loss(nn.Module):
    def __init__(self, soft_dice_kwargs, ce_kwargs, 
        ...
        """
        CAREFUL. Weights for CE and Dice do not need to sum to one. 
        You can set whatever you want.
        :param soft_dice_kwargs:
        :param ce_kwargs:
        :param aggregate:  aggregation method between the 2 losses.
        :param square_dice:  flag whether to square the dice loss or not.
        :param weight_ce:  class weights for CE
        :param weight_dice:  class weights for DC
        """
