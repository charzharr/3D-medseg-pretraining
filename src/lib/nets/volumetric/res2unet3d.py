...
class Res2UNet3d(BaseModel):
    ...
    def forward(self, x):
        ...
        prefinal_out = F.interpolate(out, scale_factor=2, mode='trilinear',
                                     align_corners=True)
...
def res2net50_v1b(pretrained=False, base_width=26, **kwargs):
    """Constructs a Res2Net-50_v1b model.
    Res2Net-50 refers to the Res2Net-50_v1b_26w_4s.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Res2UNet3d(Bottle2neck, [3, 4, 6, 3], baseWidth=base_width, 
                       scale=4, **kwargs)
    return model

def res2net101_v1b(pretrained=False, base_width=26, **kwargs):
    """Constructs a Res2Net-50_v1b_26w_4s model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Res2UNet3d(Bottle2neck, [3, 4, 23, 3], baseWidth=base_width, 
                       scale=4, **kwargs)
    return model
